...
import { findProducts, findProducts2 } from "../../state/Product/Action";
...
export default function Product2() {
  ...
  const { lavelOne, lavelTwo } = useParams(); // Use the same names as in the route
  console.log("level one two", lavelOne, lavelTwo);

  useEffect(() => {
    // Dispatch findProducts2 with the correct category and subcategory
    dispatch(findProducts2({ lavelOne, lavelTwo }));
  }, [dispatch, lavelOne, lavelTwo]); // Add dispatch to the dependency array
